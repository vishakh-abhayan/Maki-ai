      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <SignIn 
          appearance={{
            elements: {
              ...
              formButtonPrimary: "bg-gradient-to-r from-blue-500 to-blue-600 hover:from-teal-600 hover:to-blue-700 text-white font-medium",
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-400 text-sm">
            ...
            <a href="/sign-up" className="text-teal-400 hover:text-teal-300 font-medium">
              Sign up
            </a>
          </p>
        </div>
